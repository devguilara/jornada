    ...
    <div class="py-12 bg-gray-900 text-gray-200 font-sans min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-800 rounded-3xl shadow-xl p-8">
                <div class="mb-8">
                    <h3 class="text-4xl font-extrabold tracking-tight text-white font-poppins">Adicionar Imagem</h3>
                    <p class="mt-2 text-sm text-gray-400">Envie uma nova imagem para sua galeria de inspiração.</p>
                </div>

                <form method="POST" action="{{ route('gallery.store') }}" enctype="multipart/form-data" class="mt-6 p-6 bg-gray-800 rounded-2xl shadow-inner-xl-dark">
                    @csrf
                    ...
                    <div class="mt-6">
                        ...
                        <textarea id="description" class="block mt-1 w-full rounded-md border-transparent bg-gray-700 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 focus:ring-offset-gray-800" name="description">{{ old('description') }}</textarea>
                    ...
                    <div class="mt-6">
                        <x-input-label for="image_file" :value="__('Ficheiro da Imagem')" class="text-gray-400" />
                        <input id="image_file" class="block mt-1 w-full text-sm text-gray-300
                               file:mr-4 file:py-2 file:px-4
                               file:rounded-full file:border-0
                               file:text-sm file:font-semibold
                               file:bg-pink-500 file:text-white
                               hover:file:bg-pink-600
                               focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 focus:ring-offset-gray-800"
                               type="file" name="image_file" required />
