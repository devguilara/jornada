...
<head>
    ...
    <!-- Estilos Customizados (Sem Efeito Glow) -->
    <style>
        body {
        ...
        /* Removido: .text-pink-500-glow */
        /* Removido: .border-pink-500-glow */
    </style>
</head>
    ...
    <nav x-data="{ open: false }" class="bg-gray-800 border-b border-gray-700 shadow-lg relative z-10 py-4">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-2">
                        {{-- Ícone de lista/documento para o projeto "Jornada do Casamento" --}}
                        ...
                        <span class="font-poppins text-xl font-bold text-white">Jornada do Casamento</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-6 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')"
                                class="relative px-4 py-2 border-b-2 border-transparent transition duration-300 ease-in-out bg-gray-800 rounded-md
                                       {{ request()->routeIs('dashboard') ? 'text-pink-400' : 'text-gray-300 hover:text-white hover:border-pink-500' }}">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                    <x-nav-link :href="route('playlists.index')" :active="request()->routeIs('playlists.index')"
                                class="relative px-4 py-2 border-b-2 border-transparent transition duration-300 ease-in-out bg-gray-800 rounded-md
                                       {{ request()->routeIs('playlists.index') ? 'text-pink-400' : 'text-gray-300 hover:text-white hover:border-pink-500' }}">
                        {{ __('Playlists') }}
                    </x-nav-link>
                    <x-nav-link :href="route('gallery.index')" :active="request()->routeIs('gallery.index')"
                                class="relative px-4 py-2 border-b-2 border-transparent transition duration-300 ease-in-out bg-gray-800 rounded-md
                                       {{ request()->routeIs('gallery.index') ? 'text-pink-400' : 'text-gray-300 hover:text-white hover:border-pink-500' }}">
                        {{ __('Galeria') }}
                    </x-nav-link>
                    <x-nav-link :href="route('notes.index')" :active="request()->routeIs('notes.index')"
                                class="relative px-4 py-2 border-b-2 border-transparent transition duration-300 ease-in-out bg-gray-800 rounded-md
                                       {{ request()->routeIs('notes.index') ? 'text-pink-400' : 'text-gray-300 hover:text-white hover:border-pink-500' }}">
                        {{ __('Notas') }}
                    </x-nav-link>
                </div>
            </div>
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-gray-800 border-t border-gray-700">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('gallery.index')" :active="request()->routeIs('gallery.index')" class="text-gray-300 hover:text-white hover:bg-gray-700">
                    {{ __('Galeria') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('notes.index')" :active="request()->routeIs('notes.index')" class="text-gray-300 hover:text-white hover:bg-gray-700">
                    {{ __('Notas') }}
                </x-responsive-nav-link>
            </div>
            ...
            <div class="pt-4 pb-1 border-t border-gray-700">
                ...
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('profile.edit')" :active="request()->routeIs('profile.edit')" class="text-gray-300 hover:text-white hover:bg-gray-700">
                        {{ __('Profile') }}
                    </x-responsive-nav-link>
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
